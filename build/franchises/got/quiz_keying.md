# GoT quiz keying (the psychometric backbone)

`out/quiz.json` is a GoT-themed re-skin of the public-domain **IPIP-50** Big-Five markers
...
Reuse this 25-slot template for future franchises (Friends/HP) per spec §14 — re-theme the wording,
