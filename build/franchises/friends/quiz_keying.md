# Friends quiz keying (the psychometric backbone)

`out/quiz.json` is a Friends-themed re-skin of the public-domain **IPIP-50** Big-Five markers
...
identical to the GoT keying — only the scenarios change.
