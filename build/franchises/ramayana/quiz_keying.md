# Ramayana quiz keying (the psychometric backbone)

`out/quiz.json` is a Ramayana-themed re-skin of the public-domain **IPIP-50** Big-Five markers
...
identical to the GoT, Friends, HP and Breaking Bad keying — only the scenarios change.
...
Shared 25-slot template across franchises (GoT/Friends/HP/Breaking Bad) per spec §14 — re-theme the
wording, keep trait + reverse identical.
